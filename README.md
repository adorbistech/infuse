...
│   │   │   ├── models.py     # CodexAdapterConfig, CodexExecutionOutput
│   │   │   └── errors.py     # Domain Codex exceptions
...
│   │   │   ├── models.py     # ClaudeAdapterConfig, ClaudeExecutionOutput
│   │   │   └── errors.py     # Domain Claude exceptions
...
│   │   ├── models.py         # EvaluationContext, GovernorDecisionRecord
│   │   └── errors.py         # Domain governor exceptions
...
│   │   ├── models.py         # ExecutionWebSummary, WebActivityRecord
│   │   └── errors.py         # Domain web observer exceptions
