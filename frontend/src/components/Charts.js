/**
 * Visualization Charts Component (SVG Token Growth & Cost vs Budget).
 */
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
      ...
      <div class="bg-surface-container rounded-xl p-4 shadow-sm flex flex-col gap-3 border border-outline-variant/15">
        <div class="flex items-center justify-between">
          ...
          <span class="font-code-sm text-code-sm text-primary font-semibold">${metrics.total_tokens.toLocaleString()} tokens</span>
        </div>

        <!-- SVG Line/Area Graph -->
        <div class="relative w-full h-44 bg-surface-container-low rounded-lg p-2 flex flex-col justify-end overflow-hidden">
          <svg class="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 400 120">
            <defs>
            ...
            <!-- Output Tokens Line (Lower volume) -->
          ...
          <div class="flex justify-between font-label-sm text-label-sm text-on-surface-variant/70 pt-1 border-t border-outline-variant/20 mt-1">
            <span>14:32 (Start)</span>
            <span>14:35</span>
            <span>14:38</span>
            <span>14:41 (Live)</span>
          </div>
        </div>
      </div>
      ...
      <div class="bg-surface-container rounded-xl p-4 shadow-sm flex flex-col gap-3 border border-outline-variant/15">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="font-code-sm text-code-sm text-on-surface font-semibold">$${metrics.current_cost_usd.toFixed(3)}</span>
          </div>
        </div>
        ...
        <div class="relative w-full h-44 bg-surface-container-low rounded-lg p-2 flex flex-col justify-end overflow-hidden">
          <svg class="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 400 120">
            ...
            <!-- Budget Warning Boundary Reference ($0.20 threshold) -->
          ...
          <div class="flex justify-between font-label-sm text-label-sm text-on-surface-variant/70 pt-1 border-t border-outline-variant/20 mt-1">
            ...
            <span>$0.05</span>
            <span>$0.10</span>
            <span class="text-tertiary font-semibold">$0.18 (Current)</span>
          </div>
        </div>
      </div>
    </div>
